...
from app.powerpaint_shape_guided_lab import router as powerpaint_shape_guided_router, templates as powerpaint_shape_guided_templates
...
for template_engine in (
    ...
    powerpaint_shape_guided_templates,
):
...
app.include_router(powerpaint_shape_guided_router)
